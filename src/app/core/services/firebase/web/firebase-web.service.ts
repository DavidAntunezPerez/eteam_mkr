...
import { FileUploaded, FirebaseDocument, FirebaseService, FIRESTORAGE_PREFIX_PATH, FirestoreImages } from "../firebase-service";
...
export class FirebaseWebService extends FirebaseService implements OnDestroy{
  ...
  async init(){
    const firebaseConfig = {
      apiKey: "AIzaSyBohiCkK6Ya0B80KRvt_IsofhgmuOBexRw",
      authDomain: "eteam-maker.firebaseapp.com",
      projectId: "eteam-maker",
      storageBucket: "eteam-maker.appspot.com",
      messagingSenderId: "171709672090",
      appId: "1:171709672090:web:097653ce5ee2f66c82cd23",
      measurementId: "G-XRDD57987B"
    };
  ...
  public subscribeToCollection(collectionName:any, subject: BehaviorSubject<any[]>, mapFunction:(el:DocumentData)=>any):Unsubscribe{
